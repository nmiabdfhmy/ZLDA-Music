...
### Get to know about all these vars in depth from our Docs. [Read Now from Here](https://notreallyshikhar.gitbook.io/zldamscbot/config-vars/available-vars)
...
4. `MONGO_DB_URI` : Get mongo db [from here.](https://notreallyshikhar.gitbook.io/zldamscbot/deployment/mongodb)
...
### How to get these? [Read from here](https://notreallyshikhar.gitbook.io/zldamscbot/deployment/spotify)
...
### How to get these? [Read from here](https://notreallyshikhar.gitbook.io/zldamscbot/config-vars/heroku-vars)
