...
from zldamsc.utils.database import get_authuser_names, get_cmode
from zldamsc.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from zldamsc.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Zlda.stop_stream(message.chat.id)
    except:
        pass
